...
_CN.LOFTR.RESNETFPN.INPUT_CHANNEL = 1
...
_CN.LOFTR.COARSE.TOPKS = [32, 16, 16]
# View conditioning (FiLM)
_CN.LOFTR.VIEW_EMBED_DIM = 64  # Dimension for view class embedding
_CN.LOFTR.USE_VIEW_FILM = False  # Enable FiLM conditioning with view class labels
...
# 3.1. Coarse-Matching Region Crop config
_CN.LOFTR.MATCH_COARSE.MATCHING_REGION_CROP = False
_CN.LOFTR.MATCH_COARSE.MATCHING_REGION_CROP_SIZE = 128
_CN.LOFTR.MATCH_COARSE.USE_EPIPOLAR_GATING = False
...
_CN.LOFTR.FINE.USE_EPIPOLAR_GATING = False
_CN.LOFTR.FINE.EPIPOLAR_GATING_MODE = "hard"
_CN.LOFTR.FINE.EPIPOLAR_TAU = 2.0
_CN.LOFTR.FINE.EPIPOLAR_THR = 2.0
_CN.LOFTR.FINE.EPIPOLAR_PSEUDO_MIN_MATCHES = 32
_CN.LOFTR.FINE.EPIPOLAR_PSEUDO_MAX_SAMPLES = 256
...
_CN.LOFTR.LOSS.TOPOLOGY_WEIGHT = 0.0
_CN.LOFTR.LOSS.TOPOLOGY_USE_LOGITS = False
...
_CN.DATASET.MGDPT_REPLACED_ROOT = (
    "/mnt/sda1/work/public_dataset/MegaDepth/phoenix/S6/zl548/MegaDepth_v1"
)

# AngioCIP options
_CN.DATASET.PAIR_LABEL_PATH = None
_CN.DATASET.GRADCAM_COMBINE_TYPE = None  # options: [None, 'cut', 'concat']
_CN.DATASET.GRADCAM_PATH = None
_CN.DATASET.GRADCAM_GAUSSIAN_SIGMA = None
_CN.DATASET.GRADCAM_GAUSSIAN_THRESHOLD = None
_CN.DATASET.BLACK_LIST_PATH = None
_CN.DATASET.EVAL_GEOMETRY_ROOT = None  # path to per-image pickles or per-pair npz for eval_metrics
...
_CN.TRAINER.COSA_TMAX = 25  # COSA: CosineAnnealing
_CN.TRAINER.ELR_GAMMA = 0.999992  # ELR: ExponentialLR, this value for 'step' interval

# plotting related
_CN.TRAINER.ENABLE_PLOTTING = True
_CN.TRAINER.N_VAL_PAIRS_TO_PLOT = 16  # number of val/test paris for plotting
...
_CN.TRAINER.SB_SUBSET_SAMPLE_REPLACEMENT = (
    False  # whether sample each scene with replacement or not
)
